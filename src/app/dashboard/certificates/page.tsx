  ...
  const generateSaleCertificate = () => {
    return `
      <div class="certificate">
        ...
        <div class="footer">
          Generated by GoatWise Farm Management • ${new Date().toLocaleDateString()}
        </div>
      </div>
    `;
  };
    ...
    return `
      <div class="certificate">
        <div class="header">
          ...
          <h2>Certificate of Veterinary Inspection</h2>
        </div>
        ...
        <div class="section">
          ...
          <div style="margin: 15px 0;">
            <p><span class="checkbox checked"></span> Animal appears healthy and free of clinical signs of infectious disease</p>
            <p><span class="checkbox checked"></span> Animal has been examined and found fit for sale/transport</p>
          </div>
          <div class="info-grid" style="margin-top: 15px;">
            <div class="info-item">
              <span class="info-label">Examination Date:</span>
              <span class="info-value">${formatDate(examDate)}</span>
            </div>
            <div class="info-item">
              <span class="info-label">Veterinarian:</span>
              <span class="info-value">${veterinarianName || '________________________'}</span>
            </div>
          </div>
        </div>
        ...
        <div class="signature-section">
          ...
          <div>
            <div class="signature-line">
              <span class="signature-label">Veterinarian Signature / License #</span>
            </div>
          </div>
        </div>
  ...
  const generatePedigreeCertificate = () => {
    ...
    return `
      <div class="certificate">
        ...
        <div class="footer">
          Generated by GoatWise Farm Management • ${new Date().toLocaleDateString()}<br>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          { type: 'health', title: 'Health Certificate', icon: Heart, description: 'Vaccination & health records' },
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            ...
            {certificateType === 'health' && (
              <>
                <div className="border-t pt-4 mt-4">
                  <h3 className="font-medium text-gray-900 mb-3">Examination Details</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <Input
                      label="Exam Date"
                      type="date"
      ...
      <Card className="p-6 bg-gray-50">
        ...
        <ul className="text-sm text-gray-600 space-y-1">
          ...
          <li>• <strong>Health Certificate:</strong> Shows vaccination and deworming history. May need vet signature for official use.</li>
