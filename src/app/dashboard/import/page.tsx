...
const IMPORT_CONFIGS: Record<ImportType, {
  ...
  animals: {
    ...
    optionalFields: ['breed', 'birth_date', 'tag_number', 'registration_number', 'color_markings', 'notes', 'purchase_date', 'purchase_price'],
    fieldLabels: {
      name: 'Name',
      sex: 'Sex',
      category: 'Category',
  ...
  financial: {
    ...
    optionalFields: ['description', 'vendor', 'animal_name', 'tax_deductible', 'notes'],
    fieldLabels: {
      date: 'Date',
      type: 'Type',
      category: 'Category',
