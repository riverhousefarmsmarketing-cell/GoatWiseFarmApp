...
export interface Database {
  public: {
    Tables: {
      ...
      // One row per individual kid. Distinct from kidding_records below, which
      // records the dam's kidding event as a whole.
      kid_records: {
        Row: { id: string; user_id: string; breeding_record_id: string; animal_id: string | null; name: string; sex: string; birth_weight: number | null; birth_weight_unit: string; birth_order: number | null; presentation: string | null; vigor_score: number | null; colostrum_time: string | null; retained: boolean; notes: string | null; created_at: string; updated_at: string; };
        Insert: { id?: string; user_id: string; breeding_record_id: string; animal_id?: string | null; name: string; sex: string; birth_weight?: number | null; birth_weight_unit?: string; birth_order?: number | null; presentation?: string | null; vigor_score?: number | null; colostrum_time?: string | null; retained?: boolean; notes?: string | null; created_at?: string; updated_at?: string; };
        Update: { breeding_record_id?: string; animal_id?: string | null; name?: string; sex?: string; birth_weight?: number | null; birth_weight_unit?: string; birth_order?: number | null; presentation?: string | null; vigor_score?: number | null; colostrum_time?: string | null; retained?: boolean; notes?: string | null; updated_at?: string; };
      };
      kidding_records: {
